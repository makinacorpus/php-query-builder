...
/**
 * Implement this in order to plug the query builder transparently upon your
 * database driver. This object will never be manipulated directly by users
 * and will simply be injected into a QueryBuilder instance instead.
 */
interface Driver
{
    /**
