...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', {
      property: 'og:image',
      content: 'https://raw.githubusercontent.com/makinacorpus/php-query-builder/main/docs/content/public/meta.png'
    }]
  ],
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://gitlab.makina-corpus.net/php/query-builder/blob/main/docs/content/:path',
